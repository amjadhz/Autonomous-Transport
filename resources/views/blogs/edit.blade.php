                    ...
                    <div class="card-body">
                        <form method="POST" action="/blogs/{{$blog->id}}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="title" type="text" class="form-control @error('title') border-danger @enderror" name="title" minlength="5" maxlength="100" value="{{ $blog->title}}" required autocomplete="title" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea class="form-control @error('description') border-danger @enderror" name="description" minlength="20" maxlength="255" rows="5">{{$blog->description}}</textarea>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea class="form-control @error('blog') border-danger @enderror" name="blog" minlength="50" rows="10">{{$blog->blog}}</textarea>
                                    @if($errors->has('blog'))
